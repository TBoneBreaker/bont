...
export const nutrientReferences: NutrientReference[] = [
  ...
  { key: 'niacin', label: 'Vitamin B₃', unit: 'mg', male: 15, female: 12, description: 'Beteiligt an Energiegewinnung und Hautfunktion.' },
  { key: 'vitamin_b6', label: 'Vitamin B₆', unit: 'mg', male: 1.6, female: 1.4, description: 'Beteiligt am Eiweißstoffwechsel und Nervensystem.' },
  { key: 'pantothenic_acid', label: 'Vitamin B₅', unit: 'mg', male: 6, female: 6, description: 'Wichtig für Energiestoffwechsel und Hormonsynthese.' },
  { key: 'biotin', label: 'Vitamin B₇', unit: 'µg', male: 40, female: 40, description: 'Unterstützt Energiestoffwechsel, Haut und Haare.' },
  ...
  { key: 'phosphorus', label: 'Phosphor', unit: 'mg', male: 700, female: 700, description: 'Beteiligt an Knochen, Zellen und Energiestoffwechsel.' },
  ...
  { key: 'copper', label: 'Kupfer', unit: 'mg', male: 1.0, female: 1.0, description: 'Unterstützt Bindegewebe, Energiegewinnung und Eisenstoffwechsel.' },
  { key: 'manganese', label: 'Mangan', unit: 'mg', male: 2.5, female: 2.0, description: 'Beteiligt an Knochen, Bindegewebe und Energiestoffwechsel.' },
  { key: 'sodium', label: 'Natrium', unit: 'mg', male: 1500, female: 1500, description: 'Wichtig für Flüssigkeitshaushalt, Nerven und Muskeln.' },
